// -----------------------------
// -- Reusable Part: VLFMASTE --
// -----------------------------
LANSA.addComponent(
{
   id: "VLFMASTE", 
   nm: "VLFMASTER_LeftSlider", 
   ot: "rp", 
   tp: "Reusable Part", 
   de: "SLIDERPANELEFT handler", 
   tl: 14020008
},
...
function( Lansa, objectId, undefined )
{
   ...
   var COM_OWNER = Lansa.registerClass( objectId,
   {
      ...
      co: function()
      {
         ...
         //
         // DEFINE_COM Class(#Prim_MD.Label) Name(#TemporaryMessage) Displayposition(1) Tabstop(False) Parent(#CustomPanelBody) Tabposition(1) Height(423) Left(8) Top(8) Width(201) Style(#BigText) CaptionAlignment(Center) Caption('This is your custom left pane slider VLFMASTER_LeftSlider. Delete this label and add your own content.') Wordwrap(True)
         //
         ...
         TEMPORARYMESSAGE.setCaption( "This is your custom left pane slider VLFMASTER_LeftSlider. Delete this label and add your own content." );
