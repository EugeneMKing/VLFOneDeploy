// -----------------------------
// -- Reusable Part: VLFMAS_4 --
// -----------------------------
LANSA.addComponent(
{
   id: "VLFMAS_4", 
   nm: "VLFMASTER_HandleLogOut", 
   ot: "rp", 
   tp: "Reusable Part", 
   de: "Log Out", 
   tl: 14020008
...
function( Lansa, objectId, undefined )
{
   ...
   COM_OWNER.mthUEXECUTE = function( parm_GOTOFREESTATE, parm_SWITCHCALLERREFERENCE )
   {
      ...
      rtn.Line( 8 );
      {
         ...
         //
         rtn.Line( 14 );
         this.REF.AVFRAMEWORKMANAGER.mthAVSWITCH( "*EXIT", undefined, undefined, undefined, this, undefined, undefined, undefined );
