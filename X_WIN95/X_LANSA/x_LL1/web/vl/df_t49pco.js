LANSA.addComponent({id:"DF_T49PCO",ot:"ww",tp:"Widget",de:"\\OC=Google Pie Chart",tl:14000101,cl:14020008},function(l,oI,u){var fF=function(wP){wP.fireItemSelected=function(pIndex,pValue,pCaption){var eP=l.ePs();eP.aI("INDEX",pIndex);eP.aI("VALUE",pValue);eP.aS("CAPTION",pCaption);l.fE(this,"ITEMSELECTED",eP);};};var fW=
