LANSA.addComponent({id:"DF_T49BCO",ot:"ww",tp:"Widget",de:"\\OC=Google Bar Chart",tl:14000101,cl:14020008},function(l,oI,u){var fF=function(wP){wP.fireItemSelected=function(pIndex,pDescription,pValue){var eP=l.ePs();eP.aI("INDEX",pIndex);eP.aS("DESCRIPTION",pDescription);eP.aI("VALUE",pValue);l.fE(this,"ITEMSELECTED",eP);};};var fW=
